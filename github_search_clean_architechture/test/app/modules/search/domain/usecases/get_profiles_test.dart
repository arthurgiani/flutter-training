...
void main() {
  ...
  group('getProfilesUsecase', () {
    ...
    test('should throw ShortProfileNameFailure when searchText.lenght < 3',
        () async {
      //Arrange
      const String searchText = '12';

      //Assert
      expect(() async => await getProfilesUsecase.call(searchText: searchText),
          throwsA(isA<ShortProfileNameFailure>()));
    });

    test(
        'should throw ShortProfileNameFailure when searchText.lenght without whitespaces < 3',
        () async {
      //Arrange
      const String searchText = 'a  a  ';
